...
EPIC_MONO=""
if [ -f "/Users/Shared/Epic Games/UE_4.20/Engine/Build/BatchFiles/Mac/SetupMono.sh" ]; then
    pushd "/Users/Shared/Epic Games/UE_4.20/Engine/Build/BatchFiles/Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'/Users/Shared/Epic Games/UE_4.20/Engine/Build/BatchFiles/Mac/SetupMono.sh';
fi
